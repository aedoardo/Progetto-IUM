...
Per quanto riguarda le recensioni, più dell'\textbf{80\%} ha detto di non rilasciarne dopo una visita. Rispetto a quanto una recensione influenzi la scelta di visitare una mostra rispetto ad un'altra, si è scoperto che questo è un fatto caratterizzante. Infatti per il \textbf{54\%} delle persone le recensioni sono influenti, se ovviamente sono verificate, infatti il \textbf{77\%} ritiene utile poterle verificare l'attendibilità\\
